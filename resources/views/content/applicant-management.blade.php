...
@section('content')
    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a class="btn btn-added add-applicant"><i data-feather="plus-circle" class="me-2"></i>Add New
                    Applicants</a>
            </div>
        </div>
        <!-- /product list -->
        <div class="card table-list-card">
            <div class="card-body pb-0">
                <div class="table-top table-top-two table-top-new d-flex ">
                    <div class="search-set mb-0 d-flex w-100 justify-content-start">
                        <div class="total-employees text-left">
                            <h6><i data-feather="users" class="feather-user"></i>Total Applicants <span
                                    class="applicant_total">21</span></h6>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table applicant-table pb-3">
                        <thead>
                            <tr>
                                <th>Applicant</th>
                                <th>Email</th>
    ...
    @livewire('content.applicant-management')
                ...
                var table = $('.applicant-table').DataTable({
                    ...
                    "columns": [
                        ...
                        <div class="edit-delete-action">
                            <a class="me-2 p-2 edit-applicant" data-applicantid="${row.applicant_id}">

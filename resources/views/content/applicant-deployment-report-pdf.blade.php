...
<head>
    ...
    <title>Applicant Deployment Report</title>
    <style>
        body {
...
<body>
    ...
    <h3 style="text-align: center; margin-top: 20px;">Applicant Deployment Report</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($record['schedule_departure_date'])->format('F j, Y') }}</td>
                <td>{{ \Carbon\Carbon::parse($record['actual_departure_date'])->format('F j, Y') }}</td>

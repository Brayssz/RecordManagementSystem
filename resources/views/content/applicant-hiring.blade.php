...
@section('content')
                ...
                <div class="table-top table-top-two table-top-new d-flex ">
                    <div class="search-set mb-0 d-flex w-100 justify-content-start">
                        ...
                        <div class="row mt-sm-3 mt-xs-3 mt-lg-0 w-sm-100 flex-grow-1">
                            ...
                            <div class="col-lg-3 col-sm-12">
                                <div class="form-group">
                                    <select class="select interview_rating_filter form-control">
                                        <option value="">Interview Rating</option>
                                        @for ($i = 1; $i <= 10; $i++)
    ...
    @livewire('content.hire-applicant')
                ...
                var table = $('.application-table').DataTable({
                    ...
                    "ajax": {
                        ...
                        "data": function(d) {
                            ...
                            d.rating = $('.interview_rating_filter').val();
                        },
                        "dataSrc": "data"
                    },
                    "columns": [{
                        ...
                        {
                            "data": "employer_interview.rating"
                        },
                        {
                            "data": null,
                            "render": function(data, type, row) {
                                ...
                                <div class="edit-delete-action">
                                    ...
                                    <a class="me-2 p-2 hire-applicant" data-applicationid="${row.application_id}">
                    ...
                    "initComplete": function(settings, json) {
                        ...
                        $('.branch_filter, .employer_filter, .interview_rating_filter').on('change', function() {
                            table.draw();
                        });

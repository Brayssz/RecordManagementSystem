...
<head>
    ...
    <title>Registered Applicants Report</title>
    <style>
        body {
...
<body>
    ...
    <h3 style="text-align: center; margin-bottom: 10px;">MMML Recruitment Agency</h3>
    ...
    <h3 style="text-align: center; margin-top: 20px;">Registered Applicants Report</h3>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $record['email'] }}</td>
                <td>{{ \Carbon\Carbon::parse($record['date_registered'])->format('F j, Y') }}</td>

<div>
                                    ...
                                    <div class="card-body">
                                        <div class="new-employee-field">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="contact_number">Mobile
                                                            Number</label>
    ...
    <div class="modal fade" id="view-branch-modal" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered modal-xl custom-modal-two">
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
    ...
    @push('scripts')
        <script>
            ...
            function handleBranchActions() {
                ...
                $(document).on('click', '.view-branch', openViewBranchModal);
            }

            const openViewBranchModal = function() {

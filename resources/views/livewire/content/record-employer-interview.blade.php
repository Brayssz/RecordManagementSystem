            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="submitEmployerInterview">
                            @csrf
                            <div class="card mb-0">
                                <div class="card-body">
                                    <div class="new-employee-field">
                                        <div class="card-title-head" wire:ignore>
                                            <h6><span><i data-feather="info" class="feather-edit"></i></span>Interview Information</h6>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div>
                                                        <textarea rows="7" cols="5" class="form-control" wire:model.lazy="remarks" placeholder="Enter interview details"></textarea>
                                                    </div>
                                                    @error('remarks')
                                            ...
                                            <div class="col-lg-12 col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="product-quantity" wire:ignore>
                                                        ...
                                                        <input type="number" class="quntity-input not_pass" id="rating" wire:model.lazy="rating">
    ...
    @push('scripts')
        <script>
            ...
            function openInterviewModal() {
                ...
                @this.set('e_interview_id', interview_id);
